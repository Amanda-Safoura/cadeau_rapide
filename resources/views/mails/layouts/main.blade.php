    ...
    <style type="text/css">
        ...
        @media only screen and (max-width:600px) {
            ...
            *[class="gmail-fix"] {
            ...
            .es-menu-1j5d99sn td:not(:last-child) {
                border-bottom: 1px solid #017478 !important
            }
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    <tr>
                                        <td style="padding:20px;Margin:0;background-color:#e7b50a" bgcolor="#e7b50a"
                                            align="left"><!--[if mso]><table style="width:560px" cellpadding="0" cellspacing="0"><tr>
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                    ...
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                                    <tr>
                                        <td align="left" bgcolor="#e7b50a"
                                            style="padding:0;Margin:0;padding-top:20px;padding-left:20px;padding-right:20px;background-color:#e7b50a">
                    ...
                    <table cellpadding="0" cellspacing="0" class="es-footer" align="center" role="none"
                        ...
                        <tr>
                            <td align="center" bgcolor="transparent" style="padding:0;Margin:0">
                                <table bgcolor="#F2F2F4" align="center" cellpadding="0" cellspacing="0"
                                    class="es-footer-body"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#F2F2F4;width:600px"
                                    role="none">
                                    <tr>
                                        <td align="left" bgcolor="#e7b50a"
                                            style="padding:0;Margin:0;padding-left:20px;padding-right:20px;background-color:#e7b50a">
                                                        ...
                                                        <table width="100%" role="presentation" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td style="padding:0;Margin:0">
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        width="100%"
                                                                        class="es-menu es-menu-1j5d99sn"
                                                                        role="presentation"
                                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                        <tr class="links">
                                                                            <td width="50%" align="center"
                                                                                ...
                                                                                style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;border:0">
                                                                                <a href="" target="_blank"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#002867;font-size:14px">Politique
                                                                                    de confidentialité</a>
                                                                            </td>
                                                                            <td align="center" valign="top"
                                                                                width="50%"
                                                                                class="es-m-p0t es-m-p0b"
                                                                                style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;border:0;border-left:1px solid #002867">
                                                                                <a target="_blank" href=""
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#002867;font-size:14px">Conditions
                                                                                    Générales</a>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-text-3616 h-auto"
                                                                    height="90"
                                                                    style="padding:0;Margin:0;padding-top:20px;padding-bottom:20px">
                                                                    <p class="es-text-mobile-size-12"
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;color:#002867;font-size:12px">
                                                                        www.cadeaurapide.com<br type="_moz"></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
