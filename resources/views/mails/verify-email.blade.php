...
<head>
    ...
    <style type="text/css">
        @media (max-width: 480px) {[class~="x_t21"] {
            padding-bottom:70px !important;
            width:420px !important;
        }
...
<body id="body" class="t40" style="min-width:100%;Margin:0px;padding:0px;background-color:#EDEDED;">
    <div class="t39" style="background-color:#EDEDED;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
            <tr>
                <td class="t38"
                    style="font-size:0;line-height:0;mso-line-height-rule:exactly;background-color:#EDEDED;"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                                <table class="t18"
                                                                                    ...
                                                                                    <tr>
                                                                                        <!--[if mso]>
<td width="246" class="t17" style="background-color:#E7B50A;overflow:hidden;text-align:center;line-height:48px;mso-line-height-rule:exactly;mso-text-raise:11px;border-radius:40px 40px 40px 40px;">
<![endif]-->
                                                                                        <!--[if !mso]>-->
                                                                                        <td class="t17"
                                                                                            style="background-color:#E7B50A;overflow:hidden;width:246px;text-align:center;line-height:48px;mso-line-height-rule:exactly;mso-text-raise:11px;border-radius:40px 40px 40px 40px;">
                                                                                            <!--<![endif]-->
                                                                                            <a class="t16"
                        ...
                        <tr>
                            <td align="center">
                                <table class="t37" role="presentation" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <!--[if mso]>
<td width="680" class="t36" style="background-color:#E7B50A;padding:80px 30px 80px 30px;">
<![endif]-->
                                        <!--[if !mso]>-->
                                        <td class="t36"
                                            style="background-color:#E7B50A;width:620px;padding:80px 30px 80px 30px;">
                                            <!--<![endif]-->
                                            <table role="presentation" width="100%" cellpadding="0"
                                                cellspacing="0" style="width:100% !important;">
                                                <tr>
                                                    <td align="center">
                                                        <table class="t35" role="presentation" cellpadding="0"
                                                            cellspacing="0"
                                                            style="Margin-left:auto;Margin-right:auto;">
                                                            <tr>
                                                                <!--[if mso]>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center">
                                                                                <table class="t25"
                                                                                    ...
                                                                                    <tr>
                                                                                        <!--[if mso]>
<td width="475" class="t24" style="border-bottom:1px solid #EDEDED;padding:0 0 60px 0;">
<![endif]-->
                                                                                        <!--[if !mso]>-->
                                                                                        <td class="t24"
                                                                                            style="border-bottom:1px solid #EDEDED;width:475px;padding:0 0 60px 0;">
                                                                                            <!--<![endif]-->
                                                                                            <h1 class="t23"
