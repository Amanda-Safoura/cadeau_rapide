...
@section('content')
    <div class="container mt-4">
        <div class="dropdown">
            <button class="btn btn-secondary dropdown-toggle" type="button" id="filter-delivering" data-bs-toggle="dropdown"
                aria-expanded="false">
            ...
            <ul class="dropdown-menu" aria-labelledby="filter-delivering">
                ...
                <li><a class="dropdown-item" href="#" onclick="updateDropdown('filter-delivering', 'Tous')">Tous</a>
                </li>
            </ul>
        </div>
                        ...
                        <tr>
                            ...
                            <td class=" text-center">
                                @if ($gift_card->is_customized)
                                    <span class="bg-success text-white p-1"><span class="d-none">customized</span><i
                                            class="fas fa-check"></i></span>
                                @else
                                    <span class="bg-danger text-white px-2 py-1"><span class="d-none">standard</span><i
                                            class="fas fa-times"></i></span>
                                @endif
                            </td>
                            <td class=" text-center">
                                @if ($gift_card->requires_delivery)
                                    <span class="bg-success text-white p-1"><span class="d-none">to_deliver</span><i
                                            class="fas fa-check"></i></span>
                                @else
                                    <span class="bg-danger text-white px-2 py-1"><span
                                            class="d-none">to_send_through_mail</span><i class="fas fa-times"></i></span>
                                @endif
                            </td>
                            <td>
