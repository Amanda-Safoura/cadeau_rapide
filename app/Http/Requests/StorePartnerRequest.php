...
class StorePartnerRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            // Images
            'picture_1.required' => 'La première image est obligatoire.',
            ...
            'picture_2.required' => 'La deuxième image est obligatoire.',
            ...
            // Description courte
            'short_description.nullable' => 'La description courte peut être vide.',
            ...
            // Adresse
            'adress.nullable' => 'L\'adresse peut être vide.',
            'adress.string' => 'L\'adresse doit être une chaîne de caractères.',

            // Tags
            'tags.nullable' => 'Les tags peuvent être vides.',
